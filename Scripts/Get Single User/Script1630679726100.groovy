...
WS.verifyElementPropertyValue(GlobalVariable.response, 'data.id', 1)

'Memastikan Value data email  yaitu george.bluth@reqres.in'
WS.verifyElementPropertyValue(GlobalVariable.response, 'data.email', 'george.bluth@reqres.in')
